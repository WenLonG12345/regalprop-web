...
import { FaWhatsapp, FaPhone, FaHeart, FaWeixin } from "react-icons/fa6"; // Standard Font Awesome 6
import { IoStar } from "react-icons/io5"; // Sharp stars for Rating if needed
import { IAgent } from "@/types/agent"; // Use the interface based on your mock data
...
export function NewAgentCard({ agent, onCardClick }: AgentCardProps) {
  return (
    <Card
      withBorder
      radius="md"
