import type { Property, Project, LocalizedText } from "./data";
...
export function buildBreadcrumbSchema(items: BreadcrumbItem[]): SchemaBreadcrumbList {
  return {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
...
export function buildPropertyListSchema(properties: Property[], localePath: string): SchemaItemList {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
...
type SchemaResidenceType = "Apartment" | "SingleFamilyResidence" | "Store" | "Warehouse" | "Residence";
...
export function buildPropertyDetailSchema(property: Property, localePath: string): SchemaOffer {
...
export function buildProjectListSchema(projects: Project[], localePath: string): SchemaItemList {
  return {
    "@context": "https://schema.org",
    "@type": "ItemList",
    url: getSiteUrl(localePath),
...
export function buildProjectDetailSchema(project: Project, localePath: string): SchemaResidence {
  return {
    "@context": "https://schema.org",
    "@type": "Residence",
