...
export type PropertyCategory = "condo" | "landed" | "commercial" | "factory";
...
export const properties: Property[] = [
	{
		...
		description: {
			...
			"zh-cn":
				"Star Residences KLCC 高楼层 3房单位，适合自住或投资，长期有专业人士租赁需求。",
		},
	...
	},
	{
		...
		description: {
			...
			"zh-cn":
				"位于 TRX Residence 的 2房单位，直通 TRX 购物中心与 MRT，适合年轻专业人士。",
		},
		agentSlugs: ["joan-lew"],
	},
	{
		...
		description: {
			...
			"zh-cn":
				"位于武吉免登核心地段的 Pavilion 系列公寓，楼下即是购物与餐饮配套。",
		},
		agentSlugs: ["jonas-woo", "joan-lew"],
	},
	{
		...
		description: {
			...
			"zh-cn":
				"位于 KLCC 边缘地段的 3房单位，格局方正，适合希望贴近市中心生活的家庭。",
		},
		agentSlugs: ["joan-lew"],
	},
	{
		...
		description: {
			...
			"zh-cn":
				"由丽思卡尔顿管理的品牌公寓，享有酒店式设施与服务，定位高端自住与长线资产配置。",
		},
		agentSlugs: ["jonas-woo"],
	},
	{
		...
		description: {
			...
			"zh-cn":
				"位于白沙罗高地的综合发展项目，楼下为生活购物商场，交通方便直达市中心。",
		},
