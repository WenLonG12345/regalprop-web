...
type PreferenceModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onSave: (values: { language: string; currency: string; unit: string }) => void;
...
export default function PreferenceModal({ 
  isOpen, onClose, onSave, languages, currencyOptions, measurementUnitOptions, selectedLang }: PreferenceModalProps) {
      ...
      <div className="modal">
        ...
        <div className="body">
          ...
          <div className="notes">
            <br/>
            <p>
              * Exchange rates are for reference only, may change without prior notice, and our company does not guarantee their accuracy. 
              Please confirm the current rate with your bank or official source before making any currency exchange.
            </p>
            <br/>
